...
const workData = [
  {
    ...
    description: "As a Full Stack Developer at Maa Gyan Services, I contribute in the development of a dynamic web application utilizing React, Haskell Servant, and PostgreSQL. Assigned with crafting resilient solutions, I focus on front-end development, using React's capabilities to engineer interfaces that prioritize accessibility and seamless interaction. Also, I actively contribute to backend development, in API design, development, and integration. Notably, the application features an online bookstore and an intuitive UI interface for adding blog posts and articles, adding depth and versatility to the platform.",
    category: "web",
    imagePath: image3,
  },
  {
    ...
    skills: ["ReactNative", "Context API", "Bluetooth", "Figma"],
    description:
